...
<body>
<div class="navbar-self" style="width: 100%;">
    <nav class="navbar navbar-dark bg-primary navbar-expand-lg" style="width: 100%;">
        <a class="navbar-brand" href="#">CRS</a>
        <div class="collapse navbar-collapse" style="float: left; margin-right: 5px;">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false" style="margin-right: 20px;">
                            #name
                        </a>
...
<div class="container-fluid">
    <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="max-width: 250px;">
            <div class="sidebar-sticky pt-3">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="#">
                            <span data-feather="register"></span>
                            点单收银 <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="nav-item">
